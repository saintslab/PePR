...
sns.scatterplot(y=tmp.test_09,x=np.log10(tmp.num_param),hue=models.type,style=models.efficient,s=ms,alpha=alpha)
plt.grid(axis='y')
plt.ylim([0.3,0.85])
plt.xlabel('Number of trainable parameters (log$_{10}$)')
...
sns.scatterplot(y=tmp.pepr_e,x=np.log10(tmp.num_param),hue=models.type,style=models.efficient,s=ms)
plt.ylim([0.3,0.85])
plt.grid(axis='y')
plt.xlabel('Number of trainable parameters (log$_{10}$)')
...
plt.subplot(131)
sns.scatterplot(y=tmp.pepr_c,x=np.log10(tmp.num_param),hue=models.type,style=models.efficient,s=ms,alpha=alpha)
plt.grid(axis='y')
plt.ylim([0.3,0.85])
plt.xlabel('Number of trainable parameters (log$_{10}$)')
...
plt.subplot(132)
sns.scatterplot(y=tmp.pepr_m,x=np.log10(tmp.num_param),hue=models.type,style=models.efficient,s=ms,alpha=alpha)
plt.grid(axis='y')
plt.ylim([0.3,0.85])
plt.xlabel('Number of trainable parameters (log$_{10}$)')
...
plt.subplot(133)
sns.scatterplot(y=tmp.pepr_t,x=np.log10(tmp.num_param),hue=models.type,style=models.efficient,s=ms,alpha=alpha)
plt.grid(axis='y')
plt.ylim([0.3,0.85])
plt.xlabel('Number of trainable parameters (log$_{10}$)')
